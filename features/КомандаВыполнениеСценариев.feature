...
Сценарий: Разбор отчетов, обработок, конфигурации на исходники.
	...
	Тогда В каталоге "." репозитория "РабочийКаталог" есть файл "DemoОтчет/DemoОтчет/Forms/ОсновнаяОФ/Ext/Form/Module.bsl"
		И В каталоге "." репозитория "РабочийКаталог" есть файл "DemoОтчет/DemoОтчет/Forms/ОсновнаяОФ/Ext/Form/form"
		И В каталоге "." репозитория "РабочийКаталог" есть файл "DemoОтчет/DemoОтчет.xml"
		И В каталоге "." репозитория "РабочийКаталог" есть файл "DemoОтчет/DemoОтчет/Templates/ОсновнаяСхемаКомпоновкиДанных.xml"
		И В каталоге "." репозитория "РабочийКаталог" есть файл "DemoОтчет/DemoОтчет/Templates/ОсновнаяСхемаКомпоновкиДанных/Ext/Template.xml"
		И В каталоге "." репозитория "РабочийКаталог" есть файл "DemoОтчет/DemoОтчет/Forms/ОсновнаяОФ.xml"
		И В каталоге "." репозитория "РабочийКаталог" есть файл "DemoОтчет/DemoОтчет/Forms/ОсновнаяОФ/Ext/Form.bin"
		И В каталоге "." репозитория "РабочийКаталог" есть файл "DemoОтчет/DemoОтчет/Forms/ОсновнаяУФ.xml"
		И В каталоге "." репозитория "РабочийКаталог" есть файл "DemoОтчет/DemoОтчет/Forms/ОсновнаяУФ/Ext/Form.xml"
		И В каталоге "." репозитория "РабочийКаталог" есть файл "DemoОбработка/DemoОбработка.xml"
		И В каталоге "." репозитория "РабочийКаталог" есть файл "DemoОбработка/DemoОбработка/Forms/ОсновнаяОФ.xml"
		И В каталоге "." репозитория "РабочийКаталог" есть файл "DemoОбработка/DemoОбработка/Forms/ОсновнаяОФ/Ext/Form.bin"
		И В каталоге "." репозитория "РабочийКаталог" есть файл "DemoОбработка/DemoОбработка/Forms/ОсновнаяУФ.xml"
		И В каталоге "." репозитория "РабочийКаталог" есть файл "DemoОбработка/DemoОбработка/Forms/ОсновнаяУФ/Ext/Form.xml"
		И В каталоге "." репозитория "РабочийКаталог" есть файл "DemoОбработка/DemoОбработка/Forms/ОсновнаяОФ/Ext/Form/Module.bsl"
		И В каталоге "." репозитория "РабочийКаталог" есть файл "DemoОбработка/DemoОбработка/Forms/ОсновнаяОФ/Ext/Form/form"
		И В каталоге "." репозитория "РабочийКаталог" есть файл "DemoРасширение/ConfigDumpInfo.xml"
		И В каталоге "." репозитория "РабочийКаталог" есть файл "DemoРасширение/Configuration.xml"
		И В каталоге "." репозитория "РабочийКаталог" есть файл "DemoРасширение/CommonModules/DemoРасш_Demo.xml"
		И В каталоге "." репозитория "РабочийКаталог" есть файл "DemoРасширение/CommonModules/DemoРасш_Demo/Ext/Module.bsl"
		И В каталоге "." репозитория "РабочийКаталог" есть файл "DemoРасширение/Subsystems/DemoРасш_Demo.xml"
		И В каталоге "." репозитория "РабочийКаталог" есть файл "DemoРасширение/Languages/Русский.xml"

...
Сценарий: Прекоммит, анализируя исходники исправляет неканоническое написание ключевых слов на каноническое 
	...
	Тогда Вывод команды "git" не содержит "В строке 92 найдено ключевое слово"
			И Вывод команды "git" содержит "В строке 27 найдено ключевое слово" 
			И Вывод команды "git" содержит "В строке 27 найдено ключевое слово"
			И Вывод команды "git" содержит "В строке 30 найдено ключевое слово"
			И Вывод команды "git" содержит "В строке 60 найдено ключевое слово"
			И Вывод команды "git" содержит "В строке 72 найдено ключевое слово"

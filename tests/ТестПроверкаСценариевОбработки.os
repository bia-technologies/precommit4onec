...
Функция ПолучитьСписокТестов(ЮнитТестирование) Экспорт
	...
	ВсеТесты.Добавить("ТестДолжен_ПроверитьСценарийСортировкаСоставаПлановОбмена");
...
Процедура ТестДолжен_ПроверитьСценарийСортировкаСоставаПлановОбмена() Экспорт

	ИмяСценария = "СортировкаСоставаПлановОбмена";
	ПроверитьОбработкуФайлов(ИмяСценария, "ExchangePlans");

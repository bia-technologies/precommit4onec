...
Функция ОбработатьФайл(АнализируемыйФайл, КаталогИсходныхФайлов, ДополнительныеПараметры) Экспорт
	...
	Если ЭтоПВХ Тогда
		ЭтоEDT = Истина;
		Лог.Отладка("Обработка файла '%1' по сценарию '%2 в рамках типов Планов видов характеристик'", АнализируемыйФайл.ПолноеИмя, ИмяСценария());
...
Функция НайтиКаталогиОбъектов(КаталогТипа, МассивОбъектов, МассивОшибок)
	...
	Для Каждого Каталог Из НайденныеКаталоги Цикл
		...
		Если МассивОбъектов.Найти(Каталог.ИмяБезРасширения) = Неопределено Тогда
			...
			// Если в каталоге есть файлы, но он не соответствует ни одному объекту метаданных - это ошибка.
			Если ФайловыеОперации.ЕстьФайлыВКаталоге(Каталог) Тогда

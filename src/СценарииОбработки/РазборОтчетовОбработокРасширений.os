...
Функция ОбработатьФайл(АнализируемыйФайл, КаталогИсходныхФайлов, ДополнительныеПараметры) Экспорт
	...
	НастройкиИБ = Новый Структура("ПутьИБ,ЛогинИБ,ПарольИБ");
	ЗаполнитьЗначенияСвойств(НастройкиИБ, ДополнительныеПараметры);
...
Функция ПодготовитьКонфигуратор(ИспользуемаяВерсияПлатформы)
	...
	Если ЗначениеЗаполнено(НастройкиИБ.ПутьИБ) Тогда
		...
		Конфигуратор.УстановитьКонтекст(НастройкиИБ.ПутьИБ, ЛогинИБ, ПарольИБ);
	КонецЕсли;

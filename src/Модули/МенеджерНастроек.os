...
Функция ЗначениеНастройки(КлючНастройки, Подпроект = Неопределено, ЗначениеПоУмолчанию = Неопределено) Экспорт
	...
	Если ИспользуютсяЛокальныеНастройки Тогда
		...
		Значение = ЗначениеНастроекПоКлючу(ЛокальныеНастройки, КлючНастройки(Подпроект, КлючНастройки));

	Иначе

		Значение = ЗначениеНастроекПоКлючу(ГлобальныеНастройки, КлючНастройки(Подпроект, КлючНастройки));

...
Функция ВыполнитьКоманду(Знач ПараметрыКоманды, Знач Приложение) Экспорт
	...
	Если ЗначениеЗаполнено(ИменаЗагружаемыхСценариев) Тогда
		Лог.Отладка("КомандаВыполнитьСценарии.ВыполнитьКоманду(): "
			+ "Перед выполнением СценарииОбработки.ПолучитьСценарииСПараметрамиВыполнения(): "
			+ "ИменаЗагружаемыхСценариев = " + СтрСоединить(ИменаЗагружаемыхСценариев, ";"));
		ЭтоПринудительноеВыполнениеУказанныхПравил = Истина; // Выполнение по явному указанию по -rules
	Иначе
		Лог.Отладка("КомандаВыполнитьСценарии.ВыполнитьКоманду(): "
			+ "Перед выполнением СценарииОбработки.ПолучитьСценарииСПараметрамиВыполнения(): ИменаЗагружаемыхСценариев = Пустые");
	КонецЕсли;
	
	НаборНастроек = СценарииОбработки.ПолучитьСценарииСПараметрамиВыполнения(
						КаталогРепозитория, 

...
Функция ВыполнитьКоманду(Знач ПараметрыКоманды, Знач Приложение) Экспорт
	...
	Лог.Отладка("КомандаПрекоммит.ВыполнитьКоманду(): РазрешенныеФайлыОбработкиРегулярныеВыражения = " + СтрСоединить(РазрешенныеФайлыОбработкиРегулярныеВыражения,";"));
	ИсключенныеФайлыОбработкиРегулярныеВыражения = МенеджерНастроек.ЗначениеНастройки("ИсключенныеФайлыОбработки", "", Новый Массив);
	Лог.Отладка("КомандаПрекоммит.ВыполнитьКоманду(): ИсключенныеФайлыОбработкиРегулярныеВыражения = " + СтрСоединить(ИсключенныеФайлыОбработкиРегулярныеВыражения,";"));

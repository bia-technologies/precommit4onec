...
Функция ВыполнитьКоманду(Знач ПараметрыКоманды, Знач Приложение) Экспорт
	...
	Если МенеджерНастроек.ИспользуютсяЛокальныеНастройки() Тогда
		...
		Лог.Информация("Редактирование локальных настроек");
		
	Иначе

		Лог.Информация("Редактирование глобальных настроек");
...
Функция ИнтерактивнаяНастройка(КаталогРепозитория, УправлениеНастройками, ГлобальныеНастройки, КаталогГлобальныхСценариев, ЭтоДопПроект = Ложь)
	...
	ГлобальныеСценарии = МенеджерНастроек.ЗначениеНастройки("ГлобальныеСценарии", , Новый Массив());
	ОтключенныеСценарии = МенеджерНастроек.ЗначениеНастройки("ОтключенныеСценарии", , Новый Массив);
	...
	Если ПолучитьНастройкуБулево("Выполнить настройку подключенных глобальных сценариев?", Истина) Тогда
		...
		ГлобальныеСценарии = ПолучитьНастройкуМассив("Выберите подключаемые глобальные сценарии: ", 
			ИменаСценариев, ?(ЗначениеЗаполнено(ГлобальныеСценарии), ГлобальныеСценарии, ИменаСценариев));
	...
	ИначеЕсли ПолучитьНастройкуБулево("Выполнить настройку отключенных глобальных сценариев?", Истина) Тогда
		...
		ОтключенныеСценарии = ПолучитьНастройкуМассив("Выберите отключаемые глобальные сценарии: ", 
			ИменаСценариев, ОтключенныеСценарии);
	...
	Если ЗначениеЗаполнено(ГлобальныеСценарии) Тогда
		
		ИсполняемыеСценарии = МенеджерНастроек.ПолучитьСписокИсполяемыхСценариев(ГлобальныеСценарии, ОтключенныеСценарии);
		
	Иначе

		ИсполняемыеСценарии = МенеджерНастроек.ПолучитьСписокИсполяемыхСценариев(ИменаСценариев, ОтключенныеСценарии);
